...
**版本 V2.4 (2026-03-12)** 針對生產環境反饋的「約束衝突」、「幾何碎片化」等問題進行底層重構：

- ✨ **連續尺寸標註鎖定 (Continuous Dimension Locking)** — 「拉動一條線，整張網子跟著平移」
- ✨ **舊網格自動清除機制** — 一鍵重繪時無約束衝突，安全應對牆體尺寸變更
- ✨ **貫穿式長刀設計** — 避免邊界碎片化，邊界安全延伸 500 mm
- ✨ **雙向獨立灰縫參數** — 水平與垂直灰縫分別控制
- ✨ **詳細完成訊息** — 用戶明確掌握每次操作的結果

👉 **詳細技術文檔**: 見 [V24_TECHNICAL_GUIDE.md](V24_TECHNICAL_GUIDE.md)
